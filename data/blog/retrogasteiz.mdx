...
draft: false
authors: ['default']
summary: 'Retrogasteiz es una plataforma web que explora el archivo fotográfico de Álava. Utiliza tecnología avanzada como reconocimiento facial y coloración de imágenes para proporcionar una experiencia interactiva y personalizada. Además, presenta mejoras en la precisión de los datos y una interfaz de usuario moderna. Retrogasteiz amplía el acceso al archivo histórico y busca realzar el patrimonio fotográfico de Álava mediante innovadoras técnicas de visualización.'
