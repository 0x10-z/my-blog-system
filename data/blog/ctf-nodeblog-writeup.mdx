...
draft: true
authors: ['default']
summary: nmap me cuesta descubrir cosas He tenido que ralentizar el comando de descubrir todos los pueortos 
---
...
![](https://blog.ikerocio.com/content/images/2022/02/Screenshot\_2.png)Tiene un login.
...
```
![](https://blog.ikerocio.com/content/images/2022/02/Screenshot\_4.png)Es vulnerable. Modifico el script para probar otras cosas.
...
```
![](https://blog.ikerocio.com/content/images/2022/02/Screenshot\_5.png)Antes de enviarlo, codifico el contenido de auth= a URLEncoding
