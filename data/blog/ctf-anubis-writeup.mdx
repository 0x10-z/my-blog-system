...
draft: true
authors: ['default']
summary: 'En este desafío de CTF llamado "Anubis", nos encontraremos con una máquina de nivel Insane que nos brinda la oportunidad de aprender todos los aspectos y detalles sobre cómo progresar en ella. La máquina ejecuta Windows y aborda aspectos relacionados con los contenedores. Iniciamos la comunicación con un Ping y escaneamos los puertos con nmap para identificar posibles vulnerabilidades. Luego, nos centramos en los puertos 443 y 445, utilizando herramientas como Crackmapexec, smbmap y smbclient para enumerar información y recursos compartidos. Continuamos con el servidor web IIS, donde encontramos un formulario que probablemente sea vulnerable a Server Side Template Injection. Utilizando diferentes técnicas, logramos inyectar código y ganar acceso a la máquina. Descubrimos que estamos en un contenedor y exploramos su contenido.'
