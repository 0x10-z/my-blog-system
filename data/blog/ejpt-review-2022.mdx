...
draft: false
authors: ['default']
summary: 'En mi blog encontrarás un resumen de mi experiencia al obtener la certificación eJPT. Es un reto de Capture The Flag que evalúa tus habilidades en pentesting y explora vulnerabilidades en redes y sistemas.'
