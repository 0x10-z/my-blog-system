...
draft: false
authors: ['default']
summary: Me estreno con este post donde me pongo en la piel de un pentester o Hacker que mola más y trato d
---
...
![](https://blog.ikerocio.com/content/images/2022/01/fases-proyecto-pentesting-768x478.png)Si bien es cierto que no es un trabajo totalmente lineal y que en cada uno de los momentos debes continuar enumerando dispositivos, analizando vulnerabilidades nuevas que te vas encontrando... podemos resumirlo del siguiente modo:
...
![](https://blog.ikerocio.com/content/images/2022/01/Screenshot\_3-1.png)Ahí está el flag de root. He tenido que recargar la página asegurándome de no cachear la respuesta, ya que al principio no era capaz de ver el resultado. Con esto finalizamos la máquina.
