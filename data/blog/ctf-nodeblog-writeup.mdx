...
draft: true
authors: ['default']
summary: 'Reto CTF que consiste en explorar una máquina con el objetivo de obtener acceso de root. El escaneo de puertos revela un servicio SSH en el puerto 22 y un servidor web Node.js en el puerto 5000. Se intenta realizar inyección SQL sin éxito, pero se descubre una vulnerabilidad de XML External entity en el servidor web. Al aprovechar esta vulnerabilidad, se logra ejecutar código y obtener acceso de usuario. Posteriormente, se obtienen las contraseñas de los usuarios y se accede como root, obteniendo las banderas del usuario y del sistema.'
