...
draft: false
authors: ['default']
summary: 'En este reto CTF de Pandora HTB, exploro una máquina que involucra vulnerabilidades como SNMP, inyección SQL, exploit de PandoraFMS y Path Hijacking para escalar privilegios.'
...
![Static website](/static/images/uploads/pandora-ctf/Screenshot\_4.webp)
