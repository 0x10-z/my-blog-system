...
draft: false
authors: ['default']
summary: 'La máquina CTF de Capture The Flag "Pandora" resultó ser más desafiante de lo esperado. La dificultad para obtener acceso inicial fue mayor de lo que se esperaba, pero finalmente obtuve acceso al sistema a través de una vulnerabilidad de inyección de SQL en el software PandoraFMS. Aprovechando esta vulnerabilidad, pude escalar privilegios hasta convertirme en el usuario root y obtener acceso total al sistema.'
images: ["/static/images/uploads/pandora-ctf/pandora-750x410.webp", "/static/images/uploads/pandora-ctf/Screenshot_1.webp", "/static/images/uploads/pandora-ctf/Screenshot_3.webp", "/static/images/uploads/pandora-ctf/Screenshot_4.webp", "/static/images/uploads/pandora-ctf/pivoting-4.svg", "/static/images/uploads/pandora-ctf/Screenshot_5.webp", "/static/images/uploads/pandora-ctf/Screenshot_6.webp", "/static/images/uploads/pandora-ctf/burpsuite2.webp"]
---

![](/static/images/uploads/pandora-ctf/pandora-750x410.webp)
...
![](/static/images/uploads/pandora-ctf/Screenshot\_1.webp)
...
![](/static/images/uploads/pandora-ctf/Screenshot\_3.webp)

/etc/hosts filePrimero de todo, verificamos conexión con el objetivo.
...
![](/static/images/uploads/pandora-ctf/pivoting-4.svg)
...
![](/static/images/uploads/pandora-ctf/Screenshot\_5.webp)

Pandora FMS 742 login3. Explotación
--------------
