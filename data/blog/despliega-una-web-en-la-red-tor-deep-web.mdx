...
draft: false
authors: ['default']
summary: 'En este artículo, aprenderás cómo desplegar una web en la red Tor, también conocida como Deep Web. Un hidden service en la red Tor es un servicio o sitio web que solo es visible dentro de la red Tor y no puede ser accedido a través de Internet público. Estos sitios web se ejecutan en servidores dentro de la red Tor y se identifican por direcciones .onion en lugar de direcciones IP convencionales. Exploraremos los archivos necesarios, como el Dockerfile y el torrc, así como la configuración de Nginx. Al final, veremos cómo probar la web utilizando Tor Browser. Las webs en la red Tor son populares tanto para actividades ilegales como legítimas debido al anonimato que proporcionan a los usuarios.'
