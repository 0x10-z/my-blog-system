...
draft: false
authors: ['default']
summary: 'En febrero de 2023, Twitter anunció que el método de autenticación de doble factor vía SMS solo estaría disponible para los usuarios de Twitter Blue. Aunque algunos medios argumentaron que esta medida favorecía a los usuarios de pago, la realidad es que el método de 2FA vía SMS es el más débil. Las estafas de SIM swap están en aumento y suplantar una tarjeta SIM es relativamente fácil. Afortunadamente, Twitter aún permite a todos los usuarios utilizar otros dos métodos de autenticación más seguros. Para aumentar la seguridad, es recomendable utilizar un método de autenticación que tenga en cuenta algo que sabes, algo que tienes y algo que eres. Aplicaciones como Latch, Google Authenticator y Microsoft Authenticator ofrecen esta funcionalidad, aunque es importante recordar que también tienen sus limitaciones. En resumen, Twitter sigue siendo seguro siempre y cuando se utilicen métodos de autenticación más seguros que el 2FA vía SMS.'
