...
draft: false
authors: ['default']
summary: Estamos ante una máquina Windows Esto es algo que deducimos una vez hacemos un Ping para comprobar 
---
...
![](https://blog.ikerocio.com/content/images/2022/02/image-7.png)Cambio la dirección IP a mi equipo y me pongo en escucha en el mismo puerto con netcat.
