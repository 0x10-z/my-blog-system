...
draft: false
authors: ['default']
summary: 'Reto CTF que consiste en comprometer sistemas que utilizan Node-RED, una herramienta de programación visual. Se explotan vulnerabilidades en los nodos "exec", "tcp in" y "tcp out" para establecer una shell reversa en el sistema. Se demuestra la importancia de proteger Node-RED mediante la configuración de la ventana de login, separación de credenciales, uso de HTTPS y deshabilitación de nodos innecesarios.'
