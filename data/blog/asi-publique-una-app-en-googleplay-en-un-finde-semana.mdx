...
draft: true
authors: ['default']
summary: 'One Cat a Day es un juego para coleccionar gatos a diario, ganar insignias especiales y explorar la diversión gatuna sin límites. ¡No te pierdas ni un gato!'
images: ['']
---
...
<Image src="/images/one-cat-a-day.png" alt="One Cat a Day screenshot" width={600} height={400} />
