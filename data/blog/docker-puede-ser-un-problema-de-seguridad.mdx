...
draft: false
authors: ['default']
summary: Docker nació o mejor dicho fue presentado al público en la PyCon de 2013 en una charla titulada 
---
...
```
![](https://blog.ikerocio.com/content/images/2022/02/image-24.png)Si no conoces como funcionan los permisos de Linux no pasa nada, simplemente créete la siguiente afirmación de lo que ocurre.
