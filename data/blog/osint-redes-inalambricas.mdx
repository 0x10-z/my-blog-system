...
draft: false
authors: ['default']
summary: 'En este post hablo sobre OSINT (Open Source Intelligence), que se refiere a técnicas y herramientas para obtener información pública en internet. Exploro la herramienta Wigle, que registra la ubicación y otra información de puntos de acceso inalámbricos en todo el mundo. Hay más de 986 millones de redes wifi registradas en Wigle, y el número de redes sin cifrar ha disminuido en los últimos años. También menciono cómo las empresas pueden usar la intensidad de la señal de las redes inalámbricas para triangular la ubicación de una persona. Espero escribir más sobre herramientas de OSINT en el futuro.'
...
Imagen obtenida de https://wigle.netEl método de uso de esta aplicación es la siguiente:
...
Estadísticas de redes y su cifrado a lo largo del tiempo en [Wigle](https://wigle.net)Como se puede ver en la imagen superior, en 20 años, el número de redes inalámbricas sin cifrar, ha pasado de ser más del 60% a convertirse en algo residual a partir del año 2018. **Buenas noticias**.
