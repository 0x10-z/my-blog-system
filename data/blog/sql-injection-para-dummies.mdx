...
draft: false
authors: ['default']
summary: En este post vamos a hablar de SQL Injection o inyección SQL para los más hispanohablantes 
---
...
![](https://blog.ikerocio.com/content/images/2022/01/sqli.svg)SQL Injection schema
...
![](https://blog.ikerocio.com/content/images/2022/01/ezgif.com-gif-maker.gif)La mayoría de las plataformas están exentas de este tipo de vulnerabilidades, aunque siempre aparecen casos nuevos que necesitan ser parcheados.
